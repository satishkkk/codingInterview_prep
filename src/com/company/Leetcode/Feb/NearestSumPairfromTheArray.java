...
public class NearestSumPairfromTheArray {
    //Given an two array and target sum find the nearest sum of two pair from the list
    public static void main(String[] args) {
        ...
        int[] b2 = {4, 5, 8, 7};
        int bTarget = 13;
        int[] out  = closestSumPair(b1, b2, bTarget);
